/*
    ...
    Profile: core
    Extensions:
        GL_ARB_bindless_texture, GL_ARB_debug_output, GL_ARB_sparse_buffer,
   GL_ARB_sparse_texture Loader: No

    Commandline:
        --profile="core" --api="gl=4.5" --generator="c" --spec="gl" --no-loader
   --extensions="GL_ARB_bindless_texture,GL_ARB_debug_output,GL_ARB_sparse_buffer,GL_ARB_sparse_texture"
    Online:
...
typedef void(APIENTRYP PFNGLMULTIDRAWELEMENTSBASEVERTEXPROC)(
    GLenum mode, const GLsizei *count, GLenum type, const void **indices,
