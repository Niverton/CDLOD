// Based on shaders demonstrated in the article at
...
void main() {
  ...
  for (int i = 0; i < nSamples; i++) {
    ...
    float fLightAngle =
        dot(perFrame.directionalLight.Direction, v3SamplePoint) / fHeight;
  ...
  // Finally, scale the Mie and Rayleigh colors and set up the varying variables
