...
Chaque partie est indépendante et parallélisable. Chaque tâche peut aussi être divisée, le diagramme de Gannt ci-contre (figure \ref{fig:gantt}) montre la répartition précise des tâche ainsi qu'un découpage du projet en fonction du temps.
