...
une planète.\\
Nous aurons besoin d'une méthode pour transformer les points dans la carte 2D en point cartésiens 3D.
...
d'éxécuter une rotation proportionnelle en x et en y du vecteur formé
par (A,B,C) et le centre de la planete. Ensuite, on norme le vecteur à la
valeur contenue dans la height map. 
...
Néanmoins nous nous attendons à des performances raisonnables de l'ordre
