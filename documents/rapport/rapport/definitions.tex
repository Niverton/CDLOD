  \chapter*{Lexique}
    ...
    %\paragraph{Carte de hauteur}\label{def:heightmap} La carte de hauteur ou Heightmap est une représentation sur une image en deux dimensions d'une troisième dimension définie comme l'altitude. 
    
    %\paragraph{CDLOD}\label{def:cdlod} Continuous Distance-Dependent Level of Detail
