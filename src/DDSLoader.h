...
public:
  ...
  virtual void create(unsigned int w, unsigned int h, unsigned int d,
...
public:
  ...
  void create(unsigned int w, unsigned int h, unsigned int d,
              unsigned int imgsize, const unsigned char *pixels);
  void clear();
...
public:
  ...
  void create_textureFlat(unsigned int format, unsigned int components,
                          const CTexture &baseImage);
  void create_texture3D(unsigned int format, unsigned int components,
                        const CTexture &baseImage);
  void
  create_textureCubemap(unsigned int format, unsigned int components,
  ...
  bool upload_texture2D(unsigned int imageIndex = 0,
...
private:
  ...
  inline unsigned int get_dword_aligned_linesize(unsigned int width,
                                                 unsigned int bpp) {
